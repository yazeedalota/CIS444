    ...
    <div class="form">
        <fieldset>
            ...
            <form name="register" action="./php/register.php" method="post">
                <input name="username" minlength="3" maxlength="20" type="text" placeholder="please enter a user name"
                    required><br>
    ...
    <div class="form">
        <fieldset>
            ...
            <form name="login" action="./php/login.php" method="post">
                <input name="username" minlength="3" maxlength="20" type="text"
                    placeholder="please enter your user name" required><br>
